export default function ContactPage() {
  return (
    <main className="pt-28 pb-20 px-6 max-w-7xl mx-auto relative overflow-hidden text-on-surface font-body selection:bg-primary/30 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10 lg:ml-[10%] max-w-4xl">
        {/* Email Card */}
        <div className="bg-surface-container-low rounded-xl p-8 border-t-4 border-primary/20 hover:border-primary transition-all duration-500 group flex flex-col items-center text-center">
          ...
          <a href="mailto:anuvanegi@gmail.com" className="mt-auto font-label font-bold text-primary hover:text-primary-container transition-colors break-all">
            anuvanegi@gmail.com
          </a>
        </div>

        {/* LinkedIn Card */}
        <div className="bg-surface-container-low rounded-xl p-8 border-t-4 border-tertiary/20 hover:border-tertiary transition-all duration-500 group flex flex-col items-center text-center">
          ...
          <a href="https://www.linkedin.com/in/anuva-negi" target="_blank" rel="noopener noreferrer" className="mt-auto font-label font-bold text-tertiary hover:text-tertiary-container transition-colors break-all">
        ...
        <div className="bg-surface-container-low rounded-xl p-8 border-t-4 border-primary/20 hover:border-primary transition-all duration-500 group flex flex-col items-center text-center">
          ...
          <a href="tel:+14694321606" className="mt-auto font-label font-bold text-primary hover:text-primary-container transition-colors">
            +1 (469) 432-1606
          </a>
        </div>
      </div>
